                ...
                <main>
                    <div class="container-fluid px-4">
						...
						<div class="card mb-4">
                            ...
                            <!--  <form  action="/MedMg/CommandServlet" method="post">-->
                                        ...
                                        <tr>
                                            ...
                                            <form  action="/MedMg/CommandServlet" method="post">
                                               <div class="form-floating">
                                                    <input class="form-control" id="inQuantity" type="text" placeholder="Enter Quantity" name="selected-quantity" />
                                                    <label for="inQuantity">Quantity</label>
                                               </div>
    										   <input type="hidden" name="med-id" value="<%=m.getId() %>" />
