                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Add a New Medicine</h3></div>
                                    <div class="card-body">
                                        <form  action="/MedMg/AddMedicine" method="post">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button class="btn btn-primary btn-block">Add New Medicine</button></div>
                                            </div>
                                        </form>
                                    </div>
                                </div>
