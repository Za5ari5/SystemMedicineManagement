...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    ...
    // pass the id of the user who we want update
    String upuid = request.getParameter("upuid");
    //request.setAttribute("upuid", upuid);
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form  action="/MedMg/UpdateUser" method="post">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <input type="hidden" name="upuid" value="<%= upuid %>" />
                                            </div>
